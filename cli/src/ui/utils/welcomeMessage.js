 ...
 */
export function createConfigErrorInstructions(validation) {
	if (validation.valid) {
		return []
	}
	const configPath = getConfigPath()
	const instructions = ["Configuration Error: config.json is incomplete or invalid.\n", "Errors found:"]
 ...
 */
export function createWelcomeMessage(options) {
	return {
		...generateMessage(),
		type: "welcome",
