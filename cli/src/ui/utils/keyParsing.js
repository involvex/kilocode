 ...
 */
export function parseKittySequence(buffer) {
	// Handle empty buffer
 ...
 */
export function isPasteModeBoundary(sequence) {
	return {
 ...
 */
export function isFocusEvent(sequence) {
	return {
 ...
 */
export function createPasteKey(text) {
	return {
		name: "",
		ctrl: false,
		meta: false,
 ...
 */
export function createSpecialKey(name, sequence = "") {
	return {
		name,
		ctrl: false,
		meta: false,
