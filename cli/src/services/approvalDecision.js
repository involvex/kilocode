 ...
 */
function getToolApprovalDecision(message, config, isCIMode) {
	try {
 ...
 */
function getCommandApprovalDecision(message, config, isCIMode) {
 ...
 */
function getFollowupApprovalDecision(message, config, isCIMode) {
 ...
 */
function getRetryApprovalDecision(message, config, isCIMode) {
 ...
 * ```
 */
export function getApprovalDecision(message, config, isCIMode) {
