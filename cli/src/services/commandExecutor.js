 ...
 */
export async function executeCommandWithContext(command, context) {
 ...
 */
export function hasRequiredArguments(command) {
 ...
 */
export function formatCommandError(command, error) {
 ...
 */
export function isCompleteCommand(input) {
