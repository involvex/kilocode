 ...
 */
function calculateMatchScore(text, query, context) {
 ...
 */
function calculateCommandMatchScore(command, query) {
 ...
 */
export function getCommandFromInput(input) {
 ...
 */
function checkDependencies(argumentDef, currentArgs, command) {
 ...
 */
export function detectInputState(input) {
 ...
 */
function createProviderContext(command, currentArgs, argumentIndex, partialInput, commandContext) {
	const argumentDef = command.arguments?.[argumentIndex]
 ...
 */
function getProvider(definition, command, currentArgs, argumentIndex, commandContext) {
 ...
 */
function filterAndScore(suggestions, query) {
	if (!query) {
		return suggestions
	}
	const lowerQuery = query.toLowerCase()
 ...
 * Generate cache key
 */
function getCacheKey(definition, command, index, partialValue) {
 ...
 */
export async function getArgumentSuggestions(input, commandContext) {
 ...
 */
export function clearArgumentCache() {
	cache.clear()
}
// ============================================================================
 ...
 */
export function detectFileMentionContext(text, cursorPosition) {
 ...
 */
export async function getFileMentionSuggestions(query, cwd, maxResults = 50) {
	try {
 ...
 */
export async function getAllSuggestions(input, cursorPosition, commandContext, cwd) {
