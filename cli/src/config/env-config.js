 ...
 */
function buildAutoApprovalFromEnv() {
	return {
 ...
 */
function applyAutoApprovalOverrides(config) {
 ...
 */
function applyCoreOverrides(config) {
	const overriddenConfig = { ...config }
	// Override mode
 ...
 */
function getProviderOverrideFields(provider) {
	const overrides = []
 ...
 */
function buildProviderFromEnv(providerType) {
