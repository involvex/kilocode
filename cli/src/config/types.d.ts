...
export declare function isValidConfig(config: unknown): config is CLIConfig
export declare function isProviderConfig(provider: unknown): provider is ProviderConfig
export {}
