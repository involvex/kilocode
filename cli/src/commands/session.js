 ...
 */
async function showSessionId(context) {
 ...
 */
async function selectSession(context, sessionId) {
 ...
 */
async function searchSessions(context, query) {
	const { addMessage } = context
	const sessionService = SessionManager.init()
	const sessionClient = sessionService.sessionClient
	if (!query) {
 ...
 */
async function forkSession(context, shareId) {
	const { addMessage, replaceMessages, refreshTerminal } = context
	const sessionService = SessionManager.init()
	if (!shareId) {
		addMessage({
 ...
 */
async function renameSession(context, newName) {
	const { addMessage } = context
	const sessionService = SessionManager.init()
	if (!newName) {
		addMessage({
 ...
 */
async function sessionIdAutocompleteProvider(context) {
	const sessionService = SessionManager.init()
	const sessionClient = sessionService.sessionClient
