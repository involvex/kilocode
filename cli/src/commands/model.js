 ...
 */
async function ensureRouterModels(context) {
 ...
 */
function filterModelsByCapabilities(models, capabilities) {
 ...
 * Paginate model list
 */
function paginateModels(modelIds, pageIndex, pageSize = MODEL_LIST_PAGE_SIZE) {
 ...
 */
async function showCurrentModel(context) {
 ...
 */
async function showModelInfo(context, modelId) {
	const { currentProvider, routerModels, kilocodeDefaultModel, addMessage } = context
	if (!currentProvider) {
		addMessage({
			id: Date.now().toString(),
 ...
 */
async function selectModel(context, modelId) {
 ...
 */
async function listModels(context, pageIndexOverride, filtersOverride) {
 ...
 */
async function listModelsPage(context, pageNum) {
 ...
 * Go to next page
 */
async function listModelsNext(context) {
	const {
		currentProvider,
		routerModels,
		kilocodeDefaultModel,
 ...
 * Go to previous page
 */
async function listModelsPrev(context) {
 ...
 * Change sort order
 */
async function listModelsSort(context, sortOption) {
 ...
 * Change filter
 */
async function listModelsFilter(context, filterOption) {
 ...
 */
async function listSubcommandAutocompleteProvider(_context) {
	return [
 ...
 */
async function sortOptionAutocompleteProvider(_context) {
 ...
 */
async function filterOptionAutocompleteProvider(_context) {
 ...
 */
async function modelAutocompleteProvider(context) {
	...
	handler: async (context) => {
		...
		switch (subcommand) {
			...
			case "list": {
				...
				if (!listSubcommand) {
					context.updateModelListFilters({ search: undefined })
					await listModels(context, undefined, { search: undefined })
					break
				}
