 ...
 */
export const isOptionalField = (field) => {
	const metadata = FIELD_REGISTRY[field]
	if (metadata) {
 ...
 */
const createFieldConfig = (field, config, defaultValue) => {
 ...
 */
export const getProviderSettings = (provider, config) => {
	switch (provider) {
		case "kilocode":
			return [
 ...
 */
export const getProviderDefaultModel = (provider) => {
