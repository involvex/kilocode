 ...
 */
export const currentHistoryEntryAtom = atom((get) => {
 ...
 */
export const currentHistoryCommandAtom = atom((get) => {
 ...
 */
export const canNavigateUpAtom = atom((get) => {
	const entries = get(historyEntriesAtom)
	const index = get(historyIndexAtom)
 ...
 */
export const canNavigateDownAtom = atom((get) => {
	const index = get(historyIndexAtom)
	return index > 0
})
// ============================================================================
 ...
 */
export const addToHistoryAtom = atom(null, async (get, set, prompt) => {
	try {
 ...
 */
export const enterHistoryModeAtom = atom(null, (get, set, originalInput = "") => {
	const entries = get(historyEntriesAtom)
 ...
 */
export const navigateHistoryUpAtom = atom(null, (get, set) => {
 ...
 * Returns the prompt to display, or null if can't navigate
 */
export const navigateHistoryDownAtom = atom(null, (get, set) => {
