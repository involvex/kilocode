 ...
 */
export const ciModeAtom = atom(false)
/**
 * Atom to store the timeout value in seconds (if provided)
 */
export const ciTimeoutAtom = atom(undefined)
/**
 * Atom to track if completion_result message was received
 */
export const ciCompletionDetectedAtom = atom(false)
/**
 * Atom to track if command/message execution has finished
 */
export const ciCommandFinishedAtom = atom(false)
/**
 * Atom to store the exit reason
 */
export const ciExitReasonAtom = atom(null)
/**
 * Action atom to set CI mode configuration
 */
export const setCIModeAtom = atom(null, (get, set, config) => {
