 ...
 */
export const textBufferStateAtom = atom({
	lines: [""],
 ...
 */
export const textBufferStringAtom = atom((get) => {
 ...
 * Get the lines array
 */
export const textBufferLinesAtom = atom((get) => {
	const state = get(textBufferStateAtom)
	return [...state.lines]
})
/**
 ...
 */
export const textBufferCursorAtom = atom((get) => {
	const state = get(textBufferStateAtom)
	return { ...state.cursor }
})
/**
 ...
 */
export const textBufferCurrentLineAtom = atom((get) => {
	const state = get(textBufferStateAtom)
 ...
 * Get the line count
 */
export const textBufferLineCountAtom = atom((get) => {
	const state = get(textBufferStateAtom)
 ...
 */
export const textBufferIsEmptyAtom = atom((get) => {
	const state = get(textBufferStateAtom)
 ...
 */
export const moveToAtom = atom(null, (get, set, position) => {
	const state = get(textBufferStateAtom)
 ...
 */
export const insertCharAtom = atom(null, (get, set, char) => {
	if (char === "\n") {
 ...
 */
export const insertTextAtom = atom(null, (get, set, text) => {
	if (!text) return
	const state = get(textBufferStateAtom)
 ...
 */
export const setTextAtom = atom(null, (get, set, text) => {
 ...
 */
export const getVisualLinesAtom = atom(null, (get, set, params) => {
 ...
 */
export const getVisualCursorAtom = atom(null, (get, set, width) => {
