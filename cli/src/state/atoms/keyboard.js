 ...
 */
export const keyboardSubscribersAtom = atom(new Set())
/**
 * Whether raw mode is currently enabled for stdin
 */
export const rawModeEnabledAtom = atom(false)
/**
 * Whether Kitty keyboard protocol is enabled
 */
export const kittyProtocolEnabledAtom = atom(false)
/**
 * Debug mode for logging keystrokes
 */
export const debugKeystrokeLoggingAtom = atom(false)
// ============================================================================
// Buffer Atoms
// ============================================================================
/**
 ...
 */
export const pasteBufferAtom = atom("")
/**
 * Buffer for incomplete Kitty protocol sequences
 */
export const kittySequenceBufferAtom = atom("")
/**
 * Buffer for detecting backslash+enter combination
 */
export const backslashBufferAtom = atom(false)
// ============================================================================
// Mode Atoms
// ============================================================================
/**
 ...
 */
export const isPasteModeAtom = atom(false)
/**
 * Whether we're waiting for Enter after backslash
 */
export const waitingForEnterAfterBackslashAtom = atom(false)
// ============================================================================
// Event Atoms
// ============================================================================
/**
 ...
 */
export const currentKeyEventAtom = atom(null)
/**
 * History of recent key events (for debugging)
 */
export const keyEventHistoryAtom = atom([])
/**
 ...
 */
export const subscriberCountAtom = atom((get) => {
	return get(keyboardSubscribersAtom).size
})
/**
 * Whether any subscribers are active
 */
export const hasSubscribersAtom = atom((get) => {
 ...
 */
export const subscribeToKeyboardAtom = atom(null, (get, set, handler) => {
 ...
 */
export const unsubscribeFromKeyboardAtom = atom(null, (get, set, handler) => {
	const subscribers = new Set(get(keyboardSubscribersAtom))
 ...
 */
export const broadcastKeyEventAtom = atom(null, (get, set, key) => {
 ...
 * Set paste mode
 */
export const setPasteModeAtom = atom(null, (get, set, isPaste) => {
 ...
 */
export const appendToPasteBufferAtom = atom(null, (get, set, text) => {
 ...
 */
export const appendToKittyBufferAtom = atom(null, (get, set, text) => {
 ...
 */
export const setDebugLoggingAtom = atom(null, (get, set, enabled) => {
	set(debugKeystrokeLoggingAtom, enabled)
})
/**
 * Enable/disable Kitty protocol
 */
export const setKittyProtocolAtom = atom(null, (get, set, enabled) => {
 ...
 */
export const submissionCallbackAtom = atom({ callback: null })
/**
 * Atom to handle input submission
 * This is called when the user presses Enter to submit input
 */
export const submitInputAtom = atom(null, (get, set, text) => {
 ...
 */
function calculateRowColumnFromPosition(text, absolutePosition) {
 ...
 */
function formatSuggestion(suggestion, currentInput, fileMentionContext) {
 ...
 */
function handleApprovalKeys(get, set, key) {
 ...
 */
function handleFollowupKeys(get, set, key) {
	const selectedIndex = get(selectedIndexAtom)
 ...
 */
function handleAutocompleteKeys(get, set, key) {
	const selectedIndex = get(selectedIndexAtom)
 ...
 */
function handleHistoryKeys(get, set, key) {
	switch (key.name) {
		case "up": {
 ...
 */
async function handleShellKeys(get, set, key) {
 ...
 */
function handleTextInputKeys(get, set, key) {
...
function handleGlobalHotkeys(get, set, key) {
	switch (key.name) {
		case "c":
			if (key.ctrl) {
				process.exit(0)
 ...
 */
export const keyboardHandlerAtom = atom(null, async (get, set, key) => {
...
export const setupKeyboardAtom = atom(null, (get, set) => {
	const unsubscribe = set(subscribeToKeyboardAtom, (key) => {
