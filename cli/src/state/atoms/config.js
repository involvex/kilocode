...
export const configAtom = atom(DEFAULT_CONFIG)
// Validation result atom - holds the validation status of the current config
export const configValidationAtom = atom({ valid: true })
// Loading state atom
export const configLoadingAtom = atom(false)
// Error state atom
export const configErrorAtom = atom(null)
...
export const loadConfigAtom = atom(null, async (get, set, mode) => {
	try {
...
export const saveConfigAtom = atom(null, async (get, set, config) => {
	try {
...
export const selectProviderAtom = atom(null, async (get, set, providerId) => {
	const config = get(configAtom)
...
export const addProviderAtom = atom(null, async (get, set, provider) => {
	const config = get(configAtom)
...
export const updateProviderAtom = atom(null, async (get, set, providerId, updates) => {
	const config = get(configAtom)
...
export const removeProviderAtom = atom(null, async (get, set, providerId) => {
	const config = get(configAtom)
	const updatedConfig = {
		...config,
...
export const setModeAtom = atom(null, async (get, set, mode) => {
	const config = get(configAtom)
...
export const setThemeAtom = atom(null, async (get, set, theme) => {
	const config = get(configAtom)
 ...
 */
export const updateAutoApprovalAtom = atom(null, async (get, set, updates) => {
	const config = get(configAtom)
	const updatedConfig = {
		...config,
		autoApproval: {
 ...
 */
export const updateAutoApprovalSettingAtom = atom(null, async (get, set, category, updates) => {
	const config = get(configAtom)
	const updatedConfig = {
		...config,
		autoApproval: {
 ...
 */
export const addAllowedCommandAtom = atom(null, async (get, set, commandPattern) => {
	const config = get(configAtom)
 ...
 */
export const addCustomThemeAtom = atom(null, async (get, set, themeId, theme) => {
	const config = get(configAtom)
 ...
 */
export const removeCustomThemeAtom = atom(null, async (get, set, themeId) => {
	const config = get(configAtom)
 ...
 */
export const updateCustomThemeAtom = atom(null, async (get, set, themeId, updates) => {
	const config = get(configAtom)
	if (!config.customThemes || !config.customThemes[themeId]) {
		throw new Error(`Custom theme "${themeId}" not found`)
	}
