 ...
 */
export const sendWebviewMessageAtom = atom(null, async (get, set, message) => {
 ...
 */
export const sendTaskAtom = atom(null, async (get, set, params) => {
 ...
 */
export const sendAskResponseAtom = atom(null, async (get, set, params) => {
	const message = {
		type: "askResponse",
	}
	if (params.response) {
 ...
 */
export const switchModeAtom = atom(null, async (get, set, mode) => {
	const message = {
		type: "mode",
		text: mode,
	}
 ...
 */
export const respondToToolAtom = atom(null, async (get, set, params) => {
	const message = {
		type: "askResponse",
 ...
 */
export const sendApiConfigurationAtom = atom(null, async (_get, set, apiConfiguration) => {
	const message = {
 ...
 */
export const sendCustomInstructionsAtom = atom(null, async (get, set, instructions) => {
	const message = {
 ...
 */
export const sendAlwaysAllowAtom = atom(null, async (get, set, alwaysAllow) => {
	const message = {
		type: "updateSettings",
		updatedSettings: {
 ...
 */
export const openFileAtom = atom(null, async (get, set, filePath) => {
	const message = {
		type: "openFile",
		text: filePath,
	}
