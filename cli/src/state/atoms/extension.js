 ...
 */
export const extensionStateAtom = atom(null)
/**
 ...
 */
export const taskTodosAtom = atom([])
/**
 * Atom to hold available router models
 */
export const routerModelsAtom = atom(null)
/**
 * Atom to hold the current API configuration
 */
export const apiConfigurationAtom = atom(null)
/**
 * Atom to hold the current mode
 */
export const extensionModeAtom = atom("code")
/**
 * Atom to hold custom modes
 */
export const customModesAtom = atom([])
/**
 ...
 */
export const cwdAtom = atom(null)
/**
 ...
 */
export const extensionVersionAtom = atom((get) => {
 ...
 */
export const currentApiConfigNameAtom = atom((get) => {
	const state = get(extensionStateAtom)
 ...
 */
export const taskHistoryLengthAtom = atom((get) => {
	const state = get(extensionStateAtom)
 ...
 */
export const renderContextAtom = atom((get) => {
	const state = get(extensionStateAtom)
 ...
 */
export const hasChatMessagesAtom = atom((get) => {
 ...
 */
export const lastChatMessageAtom = atom((get) => {
	const messages = get(chatMessagesAtom)
 ...
 */
export const hasActiveTaskAtom = atom((get) => {
 ...
 */
export const inProgressTodosCountAtom = atom((get) => {
	const todos = get(taskTodosAtom)
 ...
 */
export const updateExtensionStateAtom = atom(null, (get, set, state) => {
	...
	if (state) {
		...
		set(streamingMessagesSetAtom, new Set())
	}
})
/**
 ...
 */
export const updateChatMessagesAtom = atom(null, (get, set, messages) => {
 ...
 */
export const addChatMessageAtom = atom(null, (get, set, message) => {
	const messages = get(chatMessagesAtom)
 ...
 */
export const updateChatMessageByTsAtom = atom(null, (get, set, updatedMessage) => {
	const messages = get(chatMessagesAtom)
	const versionMap = get(messageVersionMapAtom)
	const streamingSet = get(streamingMessagesSetAtom)
 ...
 */
export const updateCurrentTaskAtom = atom(null, (get, set, task) => {
 ...
 */
export const updateTaskTodosAtom = atom(null, (get, set, todos) => {
 ...
 */
export const updateRouterModelsAtom = atom(null, (get, set, models) => {
 ...
 */
export const updateExtensionModeAtom = atom(null, (get, set, mode) => {
 ...
 */
export const updatePartialExtensionStateAtom = atom(null, (get, set, partialState) => {
 ...
 */
function getMessageContentLength(msg) {
	let length = 0
 ...
 */
function autoCompleteOrphanedPartialAsks(messages) {
 ...
 */
function reconcileMessages(current, incoming, versionMap, streamingSet, pendingUpdates) {
	...
	const resultMessages = deduplicatedIncoming.map((incomingMsg) => {
 ...
 */
function deduplicateCommandOutputAsks(messages, pendingUpdates) {
	const result = []
	let mostRecentUnansweredAsk = null
