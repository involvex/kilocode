...
describe("CloudService", () => {
	...
	beforeEach(() => {
		...
		mockContext = {
			...
			extensionMode: 1,
			asAbsolutePath: vi.fn((relativePath) => `/mock/path/${relativePath}`),
		...
		vi.mocked(WebAuthService).mockImplementation(() => mockAuthService)
		vi.mocked(CloudSettingsService).mockImplementation(() => mockSettingsService)
		vi.mocked(CloudShareService).mockImplementation(() => mockShareService)
	...
	describe("dispose", () => {
		...
		it("should handle disposal when using StaticSettingsService", async () => {
			...
			vi.mocked(CloudSettingsService).mockImplementation(() => mockStaticSettingsService)
