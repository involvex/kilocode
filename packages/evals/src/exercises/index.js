...
export const exerciseLanguages = ["go", "java", "javascript", "python", "rust"]
export const listDirectories = async (basePath, relativePath) => {
	try {
...
export const getExercisesForLanguage = async (basePath, language) =>
