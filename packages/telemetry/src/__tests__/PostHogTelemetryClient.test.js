...
describe("PostHogTelemetryClient", () => {
	const getPrivateProperty = (instance, propertyName) => {
	...
	beforeEach(() => {
		...
		PostHog.mockImplementation(() => mockPostHogClient)
	...
	describe("isEventCapturable", () => {
		it("should return true for events not in exclude list", () => {
			...
			const isEventCapturable = getPrivateProperty(client, "isEventCapturable").bind(client)
	...
	describe("isPropertyCapturable", () => {
		it("should filter out git repository properties", () => {
			const client = new PostHogTelemetryClient()
			const isPropertyCapturable = getPrivateProperty(client, "isPropertyCapturable").bind(client)
	...
	describe("getEventProperties", () => {
		it("should merge provider properties with event properties", async () => {
			...
			const getEventProperties = getPrivateProperty(client, "getEventProperties").bind(client)
