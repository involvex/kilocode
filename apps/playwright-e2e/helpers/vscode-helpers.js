...
export async function verifyExtensionInstalled(page) {
	try {
...
export async function waitForAllExtensionActivation(page) {
	try {
...
export async function switchToTheme(page, themeName) {
	await page.keyboard.press(`${modifier}+K`)
...
export async function executeVSCodeCommand(page, commandName) {
