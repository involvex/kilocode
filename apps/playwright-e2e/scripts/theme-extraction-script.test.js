import { test, expect } from "../tests/playwright-base-test"
...
const extractVariablesForTheme = async (workbox, webviewFrame) => {
...
test.describe("CSS Variable Extraction", () => {
	test("should extract CSS variables in both light and dark themes", async ({ workbox }) => {
