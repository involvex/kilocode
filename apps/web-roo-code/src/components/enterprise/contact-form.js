...
export function ContactForm({ formType, buttonText, buttonClassName }) {
	...
	const handleSubmit = async (e) => {
		...
		const data = {
			...
			engineerCount: formData.get("engineerCount"),
			formType,
					...
					<form ref={formRef} onSubmit={handleSubmit} className="space-y-4" data-basin-form>
						...
						<div className="space-y-2">
							...
							<input
								...
								name="name"
								type="text"
								className={`w-full rounded-md border ${formErrors.name ? "border-red-500" : "border-input"} bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring`}
						...
						<div className="space-y-2">
							...
							<input
								...
								name="company"
								type="text"
								className={`w-full rounded-md border ${formErrors.company ? "border-red-500" : "border-input"} bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring`}
						...
						<div className="space-y-2">
							...
							<input
								...
								name="email"
								type="email"
								className={`w-full rounded-md border ${formErrors.email ? "border-red-500" : "border-input"} bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring`}
						...
						<div className="space-y-2">
							...
							<input
								...
								name="website"
								type="url"
								className={`w-full rounded-md border ${formErrors.website ? "border-red-500" : "border-input"} bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring`}
						...
						<div className="space-y-2">
							...
							<select
								id="engineerCount"
								name="engineerCount"
								className={`w-full rounded-md border ${formErrors.engineerCount ? "border-red-500" : "border-input"} bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring`}
								defaultValue="1-10">
