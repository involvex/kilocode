...
const parsePrice = (price) => (price ? parseFloat(price) * 1_000_000 : undefined)
...
export const useOpenRouterModels = () => useQuery({ queryKey: ["getOpenRouterModels"], queryFn: getOpenRouterModels })
