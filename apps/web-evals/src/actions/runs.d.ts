...
export declare function createRun({ suite, exercises, systemPrompt, timeout, ...values }: CreateRun): Promise<{
	model: string
	id: number
	name: string | null
...
export declare function deleteRun(runId: number): Promise<void>
