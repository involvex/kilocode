 ...
 * CreateRun
 */
export declare const MODEL_DEFAULT = "anthropic/claude-sonnet-4"
export declare const CONCURRENCY_MIN = 1
export declare const CONCURRENCY_MAX = 25
export declare const CONCURRENCY_DEFAULT = 1
export declare const TIMEOUT_MIN = 5
export declare const TIMEOUT_MAX = 10
export declare const TIMEOUT_DEFAULT = 5
export declare const createRunSchema: z.ZodEffects<
	z.ZodObject<
		{
			model: z.ZodString
