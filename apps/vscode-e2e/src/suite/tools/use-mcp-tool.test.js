...
suite.skip("Roo Code use_mcp_tool Tool", function () {
	...
	test("Should request MCP filesystem read_file tool and complete successfully", async function () {
		...
		await (0, utils_1.sleep)(2000) // Wait for Roo Code to fully initialize
		...
		await (0, utils_1.sleep)(5000) // Wait for MCP servers to initialize
		let taskId
		try {
			...
			await (0, utils_1.waitFor)(() => attemptCompletionCalled, { timeout: 45_000 })
			...
			const responseText = mcpServerResponse
