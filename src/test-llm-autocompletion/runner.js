...
import { testCases, getCategories } from "./test-cases.js"
...
export class TestRunner {
	...
	skipApproval
	useFim
	constructor(verbose = false, skipApproval = false, useFim = false) {
	...
	async runTest(testCase) {
		try {
			...
			let actualValue = prefix + completion + suffix
			if (completion === "") {
	...
	async cleanApprovals() {
		...
		function scanDirectory(dirPath, currentCategory) {
