 ...
 */
export function getFileExtensionFromTestName(testCaseName) {
 ...
 */
export function getLanguageIdFromExtension(extension) {
	const languageMap = {
		".js": "javascript",
		".ts": "typescript",
		".jsx": "javascriptreact",
 ...
 */
export function createContext(code, testCaseName) {
