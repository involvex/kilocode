...
describe("processNextEditData", () => {
	...
	beforeEach(() => {
		...
		getAutocompleteContext.mockResolvedValue("test autocomplete context")
	...
	describe("basic functionality", () => {
		...
		it("should create and store diff with unified format", async () => {
			...
			const storedEdit = prevEditModule.setPrevEdit.mock.calls[0][0]
	...
	describe("maxPromptTokens randomization", () => {
		it("should use random maxPromptTokens between 500 and 12000", async () => {
			getAutocompleteContext.mockClear()
			await processNextEditData(getBaseParams())
			const maxPromptTokens = getAutocompleteContext.mock.calls[0][7]
...
//# sourceMappingURL=processNextEditData.test.js.map
