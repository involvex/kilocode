...
import { prevEditLruCache, setPrevEdit, getPrevEditsDescending } from "./prevEditLruCache"
describe("prevEditLruCache", () => {
	beforeEach(() => {
		// Clear cache before each test
		prevEditLruCache.clear()
	})
	const createMockEdit = (timestamp, fileUri = "file:///test.ts", workspaceUri = "file:///workspace") => ({
		unidiff: `--- test.ts\n+++ test.ts\n@@ -1,1 +1,1 @@\n-old\n+new`,
		fileUri,
		workspaceUri,
		timestamp,
...
//# sourceMappingURL=prevEditLruCache.test.js.map
