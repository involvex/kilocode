...
export class GhostTextAcceptanceTracker {
	...
	setExpectedGhostTextAcceptance(document, text, startPosition) {
	...
	checkGhostTextWasAccepted(document, newPosition) {
...
//# sourceMappingURL=GhostTextAcceptanceTracker.js.map
