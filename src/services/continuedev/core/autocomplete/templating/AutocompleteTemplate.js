...
const codestralMultifileFimTemplate = {
	compilePrefixSuffix: (prefix, suffix, filepath, _reponame, snippets, workspaceUris) => {
...
const codegeexFimTemplate = {
	template: (prefix, suffix, filepath, _reponame, language, allSnippets, workspaceUris) => {
