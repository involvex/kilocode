...
describe("getAllSnippets", () => {
	...
	let mockContextRetrievalService
	beforeEach(() => {
	...
	describe("error handling", () => {
		...
		it("should pass through null from snippet sources", async () => {
			mockContextRetrievalService.getRootPathSnippets = vi.fn().mockResolvedValue(null)
			const result = await getAllSnippets({
				helper: mockHelper,
				ide: mockIde,
				getDefinitionsFromLsp: mockGetDefinitionsFromLsp,
...
//# sourceMappingURL=getAllSnippets.test.js.map
