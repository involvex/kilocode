 ...
 */
export async function searchCode(request, kilocodeToken, signal) {
 ...
 * @throws Error if the request fails
 */
export async function upsertFile(params, signal) {
	const {
		fileBuffer,
		organizationId,
		projectId,
 ...
 * @throws Error if the request fails
 */
export async function getServerManifest(organizationId, projectId, gitBranch, kilocodeToken, signal) {
	const baseUrl = getKiloBaseUriFromToken(kilocodeToken)
	try {
