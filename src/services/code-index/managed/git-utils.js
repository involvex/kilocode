 ...
 */
async function collectOutput(cmd, cwd, context) {
	const lines = []
 ...
 * @throws Error if not in a git repository
 */
export async function getCurrentCommitSha(workspacePath) {
	try {
 ...
 */
export async function getRemoteUrl(workspacePath) {
	try {
 ...
 */
export async function getGitDiff(featureBranch, baseBranch, workspacePath) {
	try {
 ...
 */
export async function isBaseBranch(branchName, workspacePath) {
 ...
 */
export async function getDefaultBranchFromRemote(workspacePath) {
	try {
 ...
 */
export async function getBaseBranch(workspacePath) {
 ...
 */
export async function hasUncommittedChanges(workspacePath) {
	try {
 ...
 */
export async function* getGitTrackedFiles(workspacePath) {
	try {
 ...
 */
export async function isDetachedHead(workspacePath) {
	try {
 ...
 */
export async function getGitHeadPath(workspacePath) {
	try {
 ...
 */
export async function getGitState(workspacePath) {
	try {
