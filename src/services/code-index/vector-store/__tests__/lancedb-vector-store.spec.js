...
describe("LocalVectorStore", () => {
	beforeEach(() => {
		vi.clearAllMocks()
		store = new LanceDBVectorStore(workspacePath, vectorSize, dbDirectory, mockLanceDBManager)
	...
	describe("isPayloadValid", () => {
		...
		it("should return true for valid payload", () => {
			const payload = { filePath: "a", codeChunk: "b", startLine: 1, endLine: 2 }
...
//# sourceMappingURL=lancedb-vector-store.spec.js.map
