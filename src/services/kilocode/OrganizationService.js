...
import { KiloOrganizationSchema } from "../../shared/kilocode/organization"
...
export class OrganizationService {
	 ...
	 */
	static async fetchOrganization(kilocodeToken, organizationId, kilocodeTesterWarningsDisabledUntil) {
		try {
	 ...
	 */
	static isCodeIndexingEnabled(organization) {
