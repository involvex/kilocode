 ...
 */
export function parseGhostResponse(fullResponse, prefix, suffix) {
	let fimText = ""
...
export class HoleFiller {
	...
	async getPrompts(autocompleteInput, languageId) {
		return {
...
`
	 ...
	 */
	async getUserPrompt(autocompleteInput, languageId) {
...
Return the COMPLETION tags`
	 ...
	 */
	async getFromChat(model, prompt, processSuggestion) {
...
//# sourceMappingURL=HoleFiller.js.map
