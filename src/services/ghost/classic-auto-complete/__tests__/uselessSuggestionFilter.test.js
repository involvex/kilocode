...
describe("postprocessGhostSuggestion", () => {
	...
	const shouldFilter = (suggestion, prefix, suffix, model = "") => {
	...
	const shouldAccept = (suggestion, prefix, suffix, model = "") => {
...
//# sourceMappingURL=uselessSuggestionFilter.test.js.map
