import { getKiloBaseUriFromToken, modelIdKeysByProvider } from "@roo-code/types"
...
export class NewAutocompleteModel {
	...
	getILLM() {
		...
		const provider = this.profile.apiProvider
		try {
	 ...
	 */
	createLLMInstance(provider, options) {
		switch (provider) {
			case "mistral":
...
//# sourceMappingURL=NewAutocompleteModel.js.map
