...
export class CommitMessageOrchestrator {
	 ...
	 */
	async generateCommitMessage(request, integration, messageGenerator) {
		let gitService = null
		try {
	 ...
	 */
	async resolveCommitChanges(gitService, selectedFiles, integration) {
...
//# sourceMappingURL=CommitMessageOrchestrator.js.map
