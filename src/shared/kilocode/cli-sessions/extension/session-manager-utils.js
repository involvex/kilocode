...
export async function kilo_execIfExtension(cb) {
	if (kilo_isCli()) {
		return Promise.resolve()
	}
	return await cb()
}
export function kilo_initializeSessionManager({ kiloToken, context, log, outputChannel, provider }) {
...
//# sourceMappingURL=session-manager-utils.js.map
