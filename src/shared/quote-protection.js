 ...
 */
export function protectNewlinesInQuotes(command, newlinePlaceholder, carriageReturnPlaceholder) {
	let result = ""
	let i = 0
 ...
 */
export function restoreNewlinesFromPlaceholders(command, newlinePlaceholder, carriageReturnPlaceholder) {
	return command
		.replace(new RegExp(newlinePlaceholder, "g"), "\n")
		.replace(new RegExp(carriageReturnPlaceholder, "g"), "\r")
}
//# sourceMappingURL=quote-protection.js.map
