...
export async function getKilocodeConfig(workspaceRoot, gitRepositoryUrl) {
 ...
 */
export async function getKilocodeConfigFile(workspaceRoot) {
 ...
 */
export async function getProjectId(workspaceRoot, gitRepositoryUrl) {
 ...
 * @returns The normalized project ID or undefined
 */
export async function getWorkspaceProjectId(gitRepositoryUrl) {
...
//# sourceMappingURL=kilo-config-file.js.map
