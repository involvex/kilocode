...
export class LanceDBManager {
	 ...
	 */
	async installLanceDBDependencies(progress) {
		try {
			const depsPath = this.getDependenciesPath()
...
//# sourceMappingURL=lancedb-manager.js.map
