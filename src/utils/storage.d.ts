...
export declare function getStorageBasePathSync(defaultPath: string): string
/**
 ...
 */
export declare function getLancedbVectorStoreDirectoryPath(globalStoragePath: string): string
/**
