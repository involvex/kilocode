 ...
 */
export class VirtualQuotaFallbackHandler extends EventEmitter {
	settingsManager
	settings
	handlerConfigs = []
	activeHandler
	...
	async adjustActiveHandler(reason) {
	...
	async notifyHandlerSwitch(newProfileId, reason) {
		let message
		if (newProfileId) {
			try {
...
//# sourceMappingURL=virtual-quota-fallback.js.map
