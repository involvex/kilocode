...
export declare function writeModels(router: RouterName, data: ModelRecord): Promise<void>
export declare function readModels(router: RouterName): Promise<ModelRecord | undefined>
/**
