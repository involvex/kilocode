...
export class MiniMaxAnthropicHandler extends BaseProvider {
	options
	client
	constructor(options) {
		super()
	...
	async *createMessage(systemPrompt, messages, metadata) {
		...
		const tool_choice = (tools ?? []).length > 0 ? { type: "any" } : undefined
	...
	getModel() {
		...
		let id = modelId && modelId in minimaxModels ? modelId : minimaxDefaultModelId
		let info = minimaxModels[id]
...
//# sourceMappingURL=minimax-anthropic.js.map
