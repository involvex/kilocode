...
describe("SapAiCoreHandler", () => {
	...
	beforeEach(() => {
		...
		vi.mocked(OrchestrationClient).mockImplementation(() => mockOrchestrationClient)
		vi.mocked(AzureOpenAiChatClient).mockImplementation(() => mockAzureOpenAiChatClient)
...
//# sourceMappingURL=sap-ai-core.spec.js.map
