...
describe("SyntheticHandler", () => {
	...
	it("should return specified model when valid model is provided", () => {
		const testModelId = "hf:zai-org/GLM-4.6"
	...
	it("createMessage should pass correct parameters to synthetic client", async () => {
		const modelId = "hf:zai-org/GLM-4.6"
		...
		const messages = [{ role: "user", content: "Test message for synthetic" }]
...
//# sourceMappingURL=synthetic.spec.js.map
