 ...
 */
export async function evaluateGatekeeperApproval(cline, toolName, toolParams) {
	try {
 ...
 */
function getGitRepository(workspaceDir) {
	try {
 ...
 */
function isFileTrackedByGit(filePath, workspaceDir) {
	try {
 ...
 */
function extractFilePathsFromCommand(command, workspaceDir) {
 ...
 */
function buildGatekeeperPrompt(toolName, toolParams, workspaceDir) {
