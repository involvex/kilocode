...
export class ProviderSettingsManager {
	...
	pendingDuplicateIdRepairReport = null
	consumeDuplicateIdRepairReport() {
	...
	async init_runMigrations() {
		try {
			return await this.lock(async () => {
				...
				let updatedCloudProfileIds
				const duplicateIdRepairReport = {}
	 ...
	 */
	async validateAutocompleteConstraint(profiles, newProfileName, newProfileType) {
