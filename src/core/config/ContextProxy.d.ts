...
export declare class ContextProxy {
	...
	private readonly configEmitter
	...
	getWorkspaceState(context: vscode.ExtensionContext, key: string): Promise<unknown>
	/**
	 * GlobalSettings
	 */
	 ...
	 */
	onManagedIndexerConfigChange(listener: (config: ManagedIndexerConfig) => void): vscode.Disposable
