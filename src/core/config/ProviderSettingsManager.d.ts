			...
			z.ZodObject<
				{
					...
					morphApiKeyMigrated: z.ZodOptional<z.ZodBoolean>
				},
				"strip",
				z.ZodTypeAny,
				{
					...
					morphApiKeyMigrated?: boolean | undefined
				},
				{
					rateLimitSecondsMigrated?: boolean | undefined
					diffSettingsMigrated?: boolean | undefined
...
export declare class ProviderSettingsManager {
	...
	private pendingDuplicateIdRepairReport
	consumeDuplicateIdRepairReport(): Record<string, string[]> | null
	...
	private _lock
	private lock
	init_runMigrations(): Promise<void>
	 ...
	 */
	private validateAutocompleteConstraint
	/**
