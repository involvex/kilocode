...
class DirectoryDeletionBlockedError extends Error {
	reason
	blockingFile
	constructor(reason, blockingFile) {
		super(reason)
		this.reason = reason
 ...
 */
async function scanDirectoryForDeletion(absolutePath, cline) {
	const stats = {
		totalFiles: 0,
		totalDirs: 0,
		totalSize: 0,
 ...
 */
export async function deleteFileTool(cline, block, askApproval, handleError, pushToolResult, removeClosingTag) {
...
//# sourceMappingURL=deleteFileTool.js.map
