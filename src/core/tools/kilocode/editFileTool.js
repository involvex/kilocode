...
import { fastApplyApiProviderSchema, getKiloUrlFromToken } from "@roo-code/types"
...
export function isFastApplyAvailable(state) {
	return (state && getFastApplyConfiguration(state).available) || false
}
export function getFastApplyModelType(state) {
