 ...
 */
export async function validateFileTokenBudget(filePath, contextWindow, currentTokens) {
	try {
 ...
 */
export function truncateFileContent(content, maxChars, totalChars, isPreview = false) {
