 ...
 */
export async function simpleReadFileTool(cline, block, askApproval, handleError, pushToolResult, _removeClosingTag) {
 ...
 */
export function getSimpleReadFileToolDescription(blockName, blockParams) {
	if (blockParams.path) {
