...
export const newTaskToolResponse = (userInput) => `<explicit_instructions type="new_task">
...
`
export const newRuleToolResponse = (userInput) => `<explicit_instructions type="new_rule">
...
`
export const reportBugToolResponse = (userInput) => `<explicit_instructions type="report_bug">
...
export const condenseToolResponse = (userInput) => `<explicit_instructions type="condense">
