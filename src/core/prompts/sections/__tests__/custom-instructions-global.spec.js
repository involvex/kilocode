...
describe("custom-instructions global .roo support", () => {
	...
	describe("loadRuleFiles", () => {
		it("should load global rules only when project rules do not exist", async () => {
			...
			mockReaddir.mockResolvedValueOnce([{ name: "rules.md", isFile: () => true, isSymbolicLink: () => false }])
	...
	describe("addCustomInstructions mode-specific rules", () => {
		it("should load global and project mode-specific rules", async () => {
			...
			mockReaddir
				.mockResolvedValueOnce([{ name: "global-mode.md", isFile: () => true, isSymbolicLink: () => false }])
				.mockResolvedValueOnce([{ name: "project-mode.md", isFile: () => true, isSymbolicLink: () => false }])
